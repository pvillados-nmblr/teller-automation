...
t3.1.7 Filter Accounts List by Status: Inactive
    ...
    Click                      ${FILTER_APPLY_BTN}
    Wait For Elements State    ${ACCOUNTS_TABLE}           visible
    Filter Accounts Results Should Contain Only Status    Inactive
...
t3.1.11 Filter Accounts List by Status: Overdrawn
    ...
    Click                      ${FILTER_APPLY_BTN}
    Wait For Elements State    ${ACCOUNTS_TABLE}           visible
    Filter Accounts Results Should Contain Only Status    Overdrawn
...
t3.1.13 Filter Accounts List by Status: Suspended
    ...
    Click                      ${FILTER_APPLY_BTN}
    Wait For Elements State    ${ACCOUNTS_TABLE}           visible
    Filter Accounts Results Should Contain Only Status    Suspended
